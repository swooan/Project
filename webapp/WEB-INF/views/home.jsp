...
<body>
	<div id="banner"
		...
		<a href="main" class="homelogo">밥풀</a>
		<ul class="homeul">
			<li class="homeli nav_login">로그인</li>
			<li class="homeli nav_join">회원가입</li>
		</ul>
		<p class="homep">맛있는 발견의 즐거움</p>
		<p class="homep2">최고의 미식 가이드, 포잉</p>

		<div class="area">
			<div class="body">
				<img src="<c:url value="${path}/res/image/home/area_marker.JPG"/>"
					alt="" id="area_marker"> <span class="label">검색할 지역을
					선택해보세요!</span> <img
					src="<c:url value="${path}/res/image/home/area_arrow.JPG"/>" alt=""
					id="area_arrow">
			</div>
			<ul class="bannerul">
				<li data-city="seoul">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp서울
					/ 수도권</li>
				<li data-city="busan">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp부산</li>
				<li data-city="jeju">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp제주</li>
				<li data-city="daegu">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp대구</li>
				<li data-city="daejeon">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp대전</li>
				<li data-city="daejeon">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp세종</li>
				<li data-city="gwangju">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp광주</li>
				<li data-city="jeonju">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp전주</li>
				<li data-city="ulsan">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp울산</li>
			</ul>
		</div>
	</div>
	...
	<div id="content">
		<div id="section main">
			<P>포잉과 떠나는 국내 미식 투어</P>
			<P>미식의 시작, 포잉과 함께 하세요.</P>
		</div>
		<div id="body">
			<div id="elements">
		...
		<div id="login_body">
			<form action="login" id="form" method="post" name="form"
				class="loginform">
				<input type="hidden" name="login_type" value="1"> <img
				...
				<input id="password" name="password" placeholder="   password"
					type="text"> <a href="javascript:%20check_empty()"
					id="submit">로그인</a>
